...
/**
 * 创建日期 2017/8/14on 10:22.
 * 描述：
 * 作者：姜贺YSKJ-JH
 */

public class MallOrderGoodsAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<MallOrderListBean.DataBean.OrderListBean.MillOrderGoodsVoListBean> arrayList;

    public MallOrderGoodsAdapter(Context context, ArrayList<MallOrderListBean.DataBean.OrderListBean.MillOrderGoodsVoListBean> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        MallOrderListBean.DataBean.OrderListBean.MillOrderGoodsVoListBean millOrderGoodsVoListBean = arrayList.get(position);
